%% Fred's UTILS: keep - reverse of clear
%
% Minor adjustment to originals by Martin Barugel and Xiaoning Yang, see text and credits below
%
% Fred Hasselman - Februari 2011

%% From original keep3.m
%
...
function keep(varargin)
    ...
    % See what is in the caller workspace
